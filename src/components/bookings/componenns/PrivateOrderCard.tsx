    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center">
                ...
                <span
                    className={`text-sm font-semibold px-3 py-1 rounded-full ${isOrderCanceled() ? "bg-gray-300 text-gray-600" : isOrderPaid() ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-800"
                        }`}
                >
                    {isOrderCanceled()
                        ? t("bookings.previous")
